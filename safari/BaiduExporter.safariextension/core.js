var CORE = (function () {
    ...
    return {
        ...
        requestCookies: function (names) {
            CONNECT.sendToHttp("get_cookies", names);
        },
        ...
        setting: {
            ...
            save: function () {
                ...
                CONNECT.sendToHttp("config_data", config_data);
        ...
        getVersion: function () {
            ...
            CONNECT.sendToHttp("rpc_version", parameter);
        },
            ...
            init: function (type) {
                if ($("#download_ui").length == 0) {
                    ...
                    $("#download_ui").on("click", "#copy_txt_btn", function () {
                        CONNECT.sendToHttp("copy_text", $("#copy_txt_btn").attr("data"));
                    });
                } else {
